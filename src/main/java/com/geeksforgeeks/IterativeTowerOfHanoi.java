...
class IterativeTowerOfHanoi {
    ...
    // Function to implement IterativeTowerOfHanoi puzzle
    void IterativeTowerOfHanoiIterative(int num_of_disks, Stack src, Stack aux, Stack dest) {
    ...
    public static void main(String[] args) {
        ...
        ob.IterativeTowerOfHanoiIterative(num_of_disks, src, aux, dest);
    }
}
